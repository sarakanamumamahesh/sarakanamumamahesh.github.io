...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container-fluid\" style=\"background-image: url(https://images.pexels.com/photos/414667/pexels-photo-414667.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940);background-repeat: no-repeat;background-size: cover;\">\n        <div >\n         <fa-icon class=\"icon\" [icon]=\"faarrowleft\" [routerLink]=\"['/home']\" routerLinkActive=\"router-link-active\" style=\"font-size: 4em;color:white;\"></fa-icon>\n         <img src=\"./assets/profile.jpg\" class=\"rounded-circle center\" alt=\"Cinque Terre\" width=\"150\" height=\"136\">\n         <h1 class=\"text-center\">RESUME</h1>\n        </div>\n        <div class=\"text-center\">\n                <legend style=\"display: inline;\">Name:</legend>\n                <h3 style=\"display: inline;\">UmaMahesh</h3>\n                <br>\n                <legend style=\"display: inline;\">Mobile:</legend>\n                <h3 style=\"display: inline;\">9505068860</h3>\n                <br>\n                <legend style=\"display: inline;\">Email</legend>\n                <h3 style=\"display: inline;\">sarakanamumamahesh@gmail.com</h3>\n        </div>\n        \n                <div class=\"text-center\">\n                    <legend>Career Objective:</legend>\n                    <p>To secure a challenging position where I can effectively contribute my skills, and innovative ideas to gain knowledge in the work oriented environment.</p>\n                </div>\n                <div class=\"text-center\">\n                    <legend >Education:</legend>\n                    <ul>\n                        <li class=\"\">Master of Computer Application ,KGRL PG COLLEGE, 6.97 CGPA ,(2018)</li>\n                        <li class=\"\">Bachelor of Science, M.E.CS , KGRL, Bhimavaram, 7.21 CGPA.</li>\n                        <li class=\"\"> Board of Intermediate Education (10+2) ,KGRL jr College.</li>\n                        <li class=\"\">Secondary School Certificate , Z.P.H School, Mogallu.</li>\n                    \n                    </ul>\n                </div>\n                <div class=\"text-center\">\n                    <legend>Technical Skills Summary:</legend>\n                    <ul>\n                        <li> Good Knowledge on Angular,TypeScript and Java</li>\n                        <li>Knowledge on windows, Linux Commands and Github.</li>\n                        <li> Having good interactions with Atom,Visual Studio Code.</li>\n                        <li> Good interpersonal skills, willing to take challenges and more responsibilities.</li>\n                        <li> Ability to learn new technologies with minimal time period.</li>\n                    </ul>\n                </div>\n                <div class=\"text-center\">\n                    <legend>Strength:</legend>\n                    <ul>\n                        <li>Able to work in a team</li>\n                        <li>Various Operating System Intraction</li>\n                        <li>Active learning and critical thinking</li>\n                    </ul>\n                </div>\n\n                <footer>\n                        <div class=\"text-center\">\n                                <legend>Personal Details</legend>\n                                <table style=\"margin-left: 35%;\">\n                                    <tr >\n                                            <th> Name:</th>\n                                            <td>Uma Mahesh</td>\n                                    </tr>\n                                    \n                                    <tr>\n                                        <th> Father Name:</th>\n                                        <td>Venkata Sthyanarayana</td>\n                                    </tr>\n                                    \n                                    <tr>\n                                        <th>Gender\t:</th>\n                                        <td> Male</td>\n                                    </tr>\n                                    <tr>\n                            <th> Date of Birth\t:</th>\n                            <td>18-07-1993</td>\n                                    </tr>\n                                    <tr>\n                                        <th>\n                                                Contact Address:\n                                        </th>\n                                        <td>\n                                        <ul>\n                                        <li>Lakshmi Narayana Puram,</li>\n                                        <li> Attili(mandal),West Godavari,</li>\n                                       <li>Andhra Pradesh,PIN:534209.</li>\n                                 </ul>\n                             </td>\n                         </tr>\n                     </table>\n                </div>\n                </footer>\n </div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<fa-icon [icon]=\"faarrowleft\" [routerLink]=\"['/home']\" routerLinkActive=\"router-link-active\" style=\"font-size: 3em;\" ></fa-icon>\n\n    <h1 class=\"text-center \">\n        Angular OpenWeather Api App \n    </h1>\n        <div class=\"icon text-center\">\n            <fa-icon [icon]=\"faspinner\" [spin]=\"true\" id=\"icon\"  ></fa-icon>\n        </div>\n    <div class=\" d-flex justify-content-center Search  \" style=\"margin-left: 10%\" >\n        <br>\n        <input type=\"text\" placeholder=\"Hyderabad\" #city>\n        <button  type=\"submit\" class=\"btn btn-primary\" style=\"margin-left: 10px \" (click)=\"getweather(city.value)\"  ><fa-icon [icon]=\"facloudsunrain\"></fa-icon>Serarch</button>\n    </div>\n    <div class=\"icon text-center\"><fa-icon [icon]=\"facoffee\" id=\"icon\"></fa-icon></div>\n        \n        <h2 class=\"text-center\" >{{wetherInfo?.name}}</h2>\n    <div *ngIf=\"visble\" style=\"margin-left: 25%;\">\n     <ul class=\" text-center list-group list-group-horizontal\">\n<li class=\"list-group-item\">\n    <label style=\"font-size: 1.5em;\">CityId<h4 >{{wetherInfo?.id}}</h4></label> \n</li>\n<li class=\"list-group-item\">\n    <label style=\"font-size: 1.5em;\">MinTemprature <h4 class=\" text-center\">{{wetherInfo?.main.temp_min}}</h4>\n        <fa-icon [icon]=\"fathermometerempty\" style=\"color: rgb(154, 155, 236);\" ></fa-icon> \n    </label>\n</li>\n<li class=\"list-group-item\">\n    <label style=\"font-size: 1.5em;\">Weather<h4 class=\"text-center\">{{wetherInfo?.weather[0].description}}</h4>\n        <fa-icon [icon]=\"facloud\" style=\"color: rgb(33, 20, 212);\"  ></fa-icon>\n    </label>\n</li>\n    <li class=\"list-group-item\">\n        <label style=\"font-size: 1.5em;\" >MaxTemprature <h4 class=\"text-center\">{{wetherInfo?.main.temp_max}}</h4>\n            <fa-icon [icon]=\"fathermometerfull\" style=\"color: red;\"  ></fa-icon>\n        </label>\n    </li>\n    <li class=\"list-group-item\">\n        <label style=\"font-size: 1.5em;\">Humidity<h4 class=\"text-center\">{{wetherInfo?.main.humidity}}</h4></label> \n    </li>\n       </ul>\n    </div>\n    <div class= \"container-fluid text-center\">\n    <p style=\"font-size: 3em;\">{{errordata?.error.message}}</p>\n    </div>\n   \n    <div style=\"margin: 5% 10%;\">\n        <h3 >Previous Search List</h3> \n        <ul class=\" text-center list-group list-group-horizontal\" *ngFor=\"let data of pastwetherInfo\">\n            \n            <li class=\"list-group-item\">\n                <label style=\"font-size: 0.8em;\">CityName<h5 class=\"text-center\">{{data?.name}}</h5></label> \n            </li>\n            \n            <li class=\"list-group-item\">\n                <label style=\"font-size: 0.8em;\">CityId<h5 >{{wetherInfo?.id}}</h5></label> \n            </li>\n            <li class=\"list-group-item\">\n                <label style=\"font-size: 0.8em;\">MinTemprature <h5 class=\" text-center\">{{data?.main.temp_min}}</h5>\n                    <fa-icon [icon]=\"fathermometerempty\" style=\"color: rgb(154, 155, 236);\" ></fa-icon> \n                </label>\n            </li>\n            <li class=\"list-group-item\">\n                <label style=\"font-size: 0.8em;\">Weather<h5 class=\"text-center\">{{data?.weather[0].description}}</h5>\n                    <fa-icon [icon]=\"facloud\" style=\"color: rgb(33, 20, 212);\"  ></fa-icon>\n                </label>\n            </li>\n                <li class=\"list-group-item\">\n                    <label style=\"font-size: 0.8em;\" >MaxTemprature <h5 class=\"text-center\">{{data?.main.temp_max}}</h5>\n                        <fa-icon [icon]=\"fathermometerfull\" style=\"color: red;\"  ></fa-icon>\n                    </label>\n                </li>\n                <li class=\"list-group-item\">\n                    <label style=\"font-size: 0.8em;\">Humidity<h5 class=\"text-center\">{{data?.main.humidity}}</h5></label> \n                </li>\n                   </ul>\n    </div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("body{\n    background-image: url(\"https://images.unsplash.com/photo-1500462918059-b1a0cb512f1d?ixlib=rb-1.2.1&auto=format&fit=crop&w=1534&q=80\");\n    background-repeat: no-repeat;\n    width: 100%;\n    height: 100%;\n    background-size: cover;\n}\nh1,h2,h3,h4{\n    color:whitesmoke;\n}\np{\n    color:rgb(37, 59, 3);\n    font-family: 'Times New Roman', Times, serif;\n    font-size: 2em;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("dev >legend{\n    font-size: 2em;\n}\n\nh1{\n    color: rgb(93, 224, 17);\n    padding-top: 5%;\n}\n\ndiv legend,div p,div table,div ul,div h3{\n    margin-left: 1%;\n}\n\ndiv{\n    background-size: cover;\n    background-repeat: no-repeat;\n}\n\n.center{\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n}\n\nlegend>h3,legend{\n    color:goldenrod;\n    margin-left: 20%;\n}\n\ndiv p,div table,div ul,div h3{\n  color: whitesmoke;\n  font-size: 1.5em;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
